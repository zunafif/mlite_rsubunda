...
class Admin extends AdminModule
{
  ...
  public function anyKontrol()
      ...
      if ($query) {
        $this->core->mysql('booking_registrasi')
          ->save([
            ...
            'kd_dokter' => $_POST['dokter'],
            'kd_poli' => $_POST['poli'],
            'no_reg' => $this->core->setNoBooking($_POST['dokter'], $_POST['tanggal_datang'], $_POST['poli']),
    ...
    public function postSaveKontrolBPJS()
    {
      ...
      $maping_dokter_dpjpvclaim = $this->core->mysql('maping_dokter_dpjpvclaim')->where('kd_dokter', $_POST['dokter'])->oneArray();
      $maping_poli_bpjs = $this->core->mysql('maping_poli_bpjs')->where('kd_poli_rs', $_POST['poli'])->oneArray();
