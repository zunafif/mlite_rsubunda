...
class Admin extends AdminModule
{
    ...
    public function getMedisRalan($no_rawat)
    {
      ...
      echo $this->draw('medisRalan.html', [
        'reg_periksa' => $this->db('reg_periksa')->where('no_rawat', revertNoRawat($no_rawat))->oneArray(),
    ...
    {
      echo $this->draw('medis.tampil.html', ['penilaian_medis_ralan' => $this->db('penilaian_medis_ralan')->where('no_rawat', revertNoRawat($no_rawat))->join('dokter', 'dokter.kd_dokter=penilaian_medis_ralan.kd_dokter')->oneArray()]);
      exit();
    }
